      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-12"
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="text-base leading-relaxed" style={{ color: "var(--color-text-secondary)" }}>
            Your group is waiting. Your streaks are counting. Let&apos;s keep the momentum going.
          </p>
          <div className="mt-12 space-y-4">
            {[{ emoji: "🔥", text: "Track your daily streaks" }, { emoji: "📊", text: "Monitor accountability scores" }, { emoji: "👥", text: "Stay connected with groups" }].map((item) => (
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-md">
          ...
          <p className="text-sm mb-8" style={{ color: "var(--color-text-secondary)" }}>
            ...
            <Link href="/signup" className="font-medium" style={{ color: "var(--color-accent-primary)" }}>Sign up</Link>
          </p>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/forgot-password" className="text-xs font-medium" style={{ color: "var(--color-accent-primary)" }}>Forgot password?</Link>
              </div>
              <div className="relative">
